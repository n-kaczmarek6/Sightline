...
const styles = StyleSheet.create({
  ...
  contact: { fontSize: 9.5, color: MUTED, marginBottom: 8 },
  label: { fontSize: 9.5, color: ACCENT, textTransform: "uppercase", letterSpacing: 1, fontFamily: "Helvetica-Bold" },
  avatar: { width: 64, height: 64, borderRadius: 32 },
  rule: { borderBottomWidth: 1.5, borderBottomColor: RULE, marginBottom: 16 },
