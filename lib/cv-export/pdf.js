...
const styles = StyleSheet.create({
  ...
  sectionTitleText: {
    fontSize: 8.5, fontFamily: "Helvetica-Bold", textTransform: "uppercase", letterSpacing: 1.2, color: ACCENT,
    marginBottom: 6, paddingBottom: 3, borderBottomWidth: 1, borderBottomColor: RULE,
  },
...
function SectionTitle({ title }) {
  return <Text style={styles.sectionTitleText}>{title}</Text>;
}
